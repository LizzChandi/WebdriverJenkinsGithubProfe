...
public class TestAllLinksMembers {
    ...
    @Test
    public void testAllLinksMembers() throws Exception {
        ...
        // ERROR: Caught exception [ERROR: Unsupported command [selectWindow | name=_e_0jzK | ]]
        driver.findElement(By.xpath("(//a[contains(text(),'Instagram')])[2]")).click();
    }
